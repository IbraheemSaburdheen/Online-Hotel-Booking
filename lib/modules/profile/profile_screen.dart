// ignore_for_file: unnecessary_new, prefer_const_constructors, sized_box_for_whitespace, avoid_unnecessary_containers
          ...
          Expanded(
            child: Padding(
              ...
              child: Column(
                ...
                children: <Widget>[
                  Text(
                    AppLocalizations(context).of("user_name"),
                    style: new TextStyle(
                      fontSize: 22,
          ...
          Padding(
            ...
            child: Container(
              ...
              child: ClipRRect(
                ...
                child: Image.asset(Localfiles.user),
              ),
            ),
          )
        ],
