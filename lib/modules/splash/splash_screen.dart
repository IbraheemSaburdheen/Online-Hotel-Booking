        ...
        body: Stack(
          children: <Widget>[
            Container(
              ...
              child: Image.asset(Localfiles.introduction4, fit: BoxFit.cover),
            ),
            Column(
              children: <Widget>[
                Expanded(
                ...
                Text(
                  ...
                  style: TextStyles(context).getBoldStyle().copyWith(
                        fontSize: 24,color: AppTheme.backgroundColor
                      ),
                ...
                AnimatedOpacity(
                  ...
                  child: Text(
                    ...
                    textAlign: TextAlign.left,
                    style: TextStyles(context).getRegularStyle().copyWith(color: AppTheme.backgroundColor),
