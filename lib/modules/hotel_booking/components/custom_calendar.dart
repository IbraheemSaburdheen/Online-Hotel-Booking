// ignore_for_file: prefer_const_constructors, avoid_unnecessary_containers, unnecessary_new, prefer_final_fields, empty_catches
...
class _CustomCalendarViewState extends State<CustomCalendarView> {
  ...
  List<Widget> getDaysNameUI() {
    ...
    for (var i = 0; i < 7; i++) {
      listUI.add(
        context.read<ThemeProvider>().languageType == LanguageType.si
            ? Padding(
