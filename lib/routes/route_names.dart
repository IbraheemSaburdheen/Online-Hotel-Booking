...
import 'package:flutter_hotel_booking_ui/modules/hotel_booking/booking_screen/bookin_screen_view.dart';
//import 'package:flutter_hotel_booking_ui/modules/hotel_booking/booking_screen/select_date.dart';
...
import '../modules/hotel_booking/booking_screen/success_screen.dart';
...
class NavigationServices {
  ...
  Future<dynamic> gotoBookingScreenScreen() async {
    return await _pushMaterialPageRoute(BookingScreen());
  }
  Future<dynamic> gotoSuccesScreen() async {
    return await _pushMaterialPageRoute(SuccesScreen());
  }
}
